...
// Trigger the Cloudflare Access edge challenge on SPA navigations into /admin.
// The Access policies on /admin* and /api/admin* edge requests are the production
// security boundary. If performance.getEntriesByType('navigation') is unavailable,
// this returns false and the edge will still challenge subsequent API requests.
