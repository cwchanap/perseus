	...
	<div class="w-full max-w-md">
		<div class="rounded-lg bg-white p-8 shadow-md">
			...
			<form onsubmit={handleSubmit}>
				...
				<div class="mb-6">
					...
					<input
						...
						bind:value={passkey}
						required
						class="w-full rounded-md border border-gray-300 px-4 py-3 focus:border-blue-500 focus:ring-2 focus:ring-blue-500/20 focus:outline-none"
			...
			<div class="mt-6 text-center">
				<a href={resolve('/')} class="text-sm text-gray-600 hover:text-gray-900">
					← Back to Gallery
				</a>
			</div>
		</div>
